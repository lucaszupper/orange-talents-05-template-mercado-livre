...
public class OpiniaoController {
	...
	@Transactional
	public ResponseEntity<Object> adicionaOpiniai(@PathVariable(name = "id") Long id, @Valid @RequestBody OpiniaoDto dto, @AuthenticationPrincipal Usuario usuario, UriComponentsBuilder builder) {
